...
public class WalletServiceImpl implements WalletService {
    ...
    public void withdrawsMoney(Long spendAmount, Long walletId) throws Exception {
    	
    	Wallet wallet = walletRepository.findWalletById(walletId);
    	if(spendAmount > wallet.getAmount()) {
    		throw new Exception("Insufficient balance");
    	}
    	Long remainAmount = wallet.getAmount()-spendAmount;
    	wallet.setAmount(remainAmount);
